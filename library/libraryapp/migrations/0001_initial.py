    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='libraryapp.author')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='libraryapp.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
